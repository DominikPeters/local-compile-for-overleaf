export const PAGE_REQUEST = 'OLLC_PAGE_REQUEST'
export const EXTENSION_RESPONSE = 'OLLC_EXTENSION_RESPONSE'
export const BYPASS_NEXT_COMPILE = 'OLLC_BYPASS_NEXT_COMPILE'
